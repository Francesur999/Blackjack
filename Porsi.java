...
public class Porsi {
    ...
    public static void main(String[] args) {
        ...
        //Baraja numero 1
     String[] cartasTrebol= {"As treboles","1 treboles","2 treboles","3 treboles","4 treboles","5 treboles","6 treboles","7 treboles","8 treboles","9 treboles","10 treboles",
    
     "J treboles","Q treboles","K treboles"};

 //Baraja numero 2
     String[] cartasPicas= {"As picas","1 picas","2 picas","3 picas","4 picas","5 picas","6 picas","7 picas","8 picas","9 picas","10 picas",
    
     "J picas","Q picas","K picas"}; 


 //Baraja numero 3
     String[] cartasDiamantes= {"As diamantes","1 diamantes","2 diamantes","3 diamantes","4 diamantes","5 diamantes","6 diamantes","7 diamantes","8 diamantes","9 diamantes","10 diamantes",
    
     "J diamantes","Q diamantes","K diamantes"};

 //Baraja numero 4
     String[] cartasCorazones= {"As corazones","1 corazones","2 corazones","3 corazones","4 corazones","5 corazones","6 corazones","7 corazones","8 corazones","9 corazones","10 corazones",
     ...
     if (numBaraja == 1) {
        ...
        if (numCarta == 0) {
            ...
            do{
            System.out.println("Salió "+cartasTrebol[numCarta]+"cuanto quieres que valga 1 0 10?");
